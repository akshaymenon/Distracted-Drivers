...
weights_path = 'C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/vgg16_weights_th_dim_ordering_th_kernels.h5'
# Enter here the path to the top-model weights files:
top_model_weights_path = 'C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/fc_model.h5'
# Enter here the path for storage of the whole model weights (VGG16+top classifier model):
whole_model_weights_path = 'C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/whole_model.h5'
...
test_data_dir = 'dataset/imgs/test'

test_images_path = 'C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/dataset/imgs/test/'
...
# =============================================================================
# model.add(ZeroPadding2D((1, 1)))
# model.add(Convolution2D(4096, 3, 3, activation='relu', name='conv6_1'))
# model.add(ZeroPadding2D((1, 1)))
# model.add(Convolution2D(4096, 3, 3, activation='relu', name='conv6_2'))
# model.add(ZeroPadding2D((1, 1)))
# model.add(Convolution2D(1000, 3, 3, activation='relu', name='conv6_3'))
# model.add(MaxPooling2D((2, 2), strides=(2, 2)))
# =============================================================================
...
model.load_weights('C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/vgg16_weights_th_dim_ordering_th_kernels.h5')
...
model.save_weights('C:/Users/aksmenon/Desktop/distracted drivers/Distracted Drivers/my_weights_tensorflow.h5')
